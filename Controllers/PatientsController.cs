...
namespace Edoc.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Password,PhoneNumber,Address,DateofBirth")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Password,PhoneNumber,Address,DateofBirth")] Patient patient)
        {
            if (id != patient.Id)
            {
                return NotFound();
